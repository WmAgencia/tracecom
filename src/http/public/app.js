...
async function shareScreen() {
  ...
  try {
    ...
    state.stream = stream; state.frames = []; state.observations = []; state.priceObservations = []; state.marketContext = null; state.contextSegmentId = `seg_${Date.now()}`; state.lastCandleId = null; state.lastAnalysis = null; state.hasSuccessfulAnalysis = false;
...
function stopScreen() {
  ...
  state.stream = null; state.crop = null; state.frames = []; state.observations = []; state.priceObservations = []; state.marketContext = null; state.contextSegmentId = null; state.lastCandleId = null; state.hasSuccessfulAnalysis = false; state.liveSessionId = null;
