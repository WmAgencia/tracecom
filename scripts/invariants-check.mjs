...
ok("ONE_OPERATIONAL_STRATEGY", v2Manifest.strategyVersion === "PULLBACK_4060_300_AGENTIC_V2" && v2Manifest.frozen === true && v3Manifest.strategyVersion === "PULLBACK_4060_300_AGENTIC_V3" && v3Manifest.status === "ACTIVE" && v3Manifest.executable === true && fs.readdirSync(new URL("../estrategias/strategy-versions", import.meta.url)).filter((f) => f.endsWith(".json") && !f.endsWith(".freeze.json")).length === 2);
ok("V3_PRACTICE_GATED", v3Manifest.executable === true && v3Manifest.status === "ACTIVE" && /PRACTICE_GATED/.test(read("relay/v3/runtime.mjs")) && /onApproved/.test(read("relay/v3/runtime.mjs")));
