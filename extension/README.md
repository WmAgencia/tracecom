...
Version 0.4.2 adds the persistent progressive shadow experiment runner. **TRACE_1M**: analysis and expiry are fixed to one minute, the
...
`dist/tracecon-extension-v0.4.2.zip` and the unpacked `dist-extension` folder.
