...
export function proxyMethodFor(path: string): "PUT" | "POST" {
  return path === "/api/iq/market" || path === "/api/iq/mesas" || path === "/api/iq/supervisor/config" || path === "/api/iq/entry/config" || path === "/api/iq/apprentice/config" || path === "/api/iq/mcp/config" || path === "/api/iq/agents/config" ? "PUT" : "POST";
}
...
/** Query string dos endpoints V3 — allowlist explicita (A11 preservado). */
export function v3QueryParams(searchParams: URLSearchParams): string {
  const token = /^[A-Za-z0-9._:-]{1,120}$/;
  const params = new URLSearchParams();
  const marketKey = String(searchParams.get("marketKey") ?? "").trim();
  ...
  if (token.test(marketKey)) params.set("marketKey", marketKey);
  if (/^[A-Z_]{3,40}$/.test(status)) params.set("status", status);
...
export default async function handler(req: IncomingMessage, res: ServerResponse): Promise<void> {
  ...
  try {
    ...
    if (path.startsWith("/api/iq/") && (req.method === "GET" || req.method === "POST" || req.method === "PUT")) {
      const getPaths = ["/api/iq/status", "/api/iq/mcp/config", "/api/iq/performance", "/api/iq/agents/log", "/api/iq/agents/config", "/api/iq/agents/shadow", "/api/iq/lab/status", "/api/iq/candles", "/api/iq/research/consensus", "/api/iq/research/consensus/log", "/api/iq/executions", "/api/iq/office", "/api/iq/markets", "/api/iq/events", "/api/iq/asset-map", "/api/iq/diagnostic/options", "/api/iq/broker-audit", "/api/iq/signals", "/api/iq/intelligence", "/api/iq/intelligence/assets", "/api/iq/strategy/stats", "/api/iq/strategy/observability", "/api/iq/v3/status", "/api/iq/v3/opportunities", "/api/iq/v3/expirations", "/api/iq/research/scoreboard", "/api/iq/research/shadow-lab", "/api/iq/research/timing-policy", "/api/iq/research/scenario-shadow", "/api/iq/research/agents-v4", "/api/iq/research/dual-reasoning", "/api/iq/research/dual-reasoning/report", "/api/iq/research/solo-reasoning", "/api/iq/research/solo-reasoning/report", "/api/iq/research/experiment/four-way/status", "/api/iq/research/experiment/four-way/report", "/api/iq/research/experiment/five-way/status", "/api/iq/research/indicator-5m", "/api/iq/research/rsi-reversal", "/api/iq/research/rsi-reversal/report", "/api/iq/research/rsi-variants", "/api/iq/research/rsi-variants/report", "/api/iq/research/rsi-agents", "/api/iq/research/rsi-agents-v2", "/api/iq/research/rsi-agents-v3", "/api/iq/research/rsi-agents-v4", "/api/iq/research/rsi-agents-v2-live", "/api/iq/research/rsi-agents-v4/events", "/api/iq/research/rsi-agents-v4/funnel", "/api/iq/mesas", "/api/iq/execution-routing", "/api/iq/research/lab/overview", "/api/iq/research/lab/factors", "/api/iq/research/lab/alphas", "/api/iq/research/lab/coverage", "/api/iq/research/lab/backtests", "/api/iq/research/lab/strategy-regime", "/api/iq/research/lab/journal-intelligence", "/api/iq/research/lab/drift", "/api/iq/research/lab/models", "/api/iq/research/lab/experiments", "/api/iq/research/lab/hypotheses", "/api/iq/research/lab/datasets", "/api/iq/research/lab/checkpoints", "/api/iq/research/lab/jobs", "/api/iq/research/lab/agents", "/api/iq/research/lab/comparison", "/api/iq/research/lab/ablation", "/api/iq/quality", "/api/iq/entry", "/api/iq/supervisor", "/api/iq/journal", "/api/iq/journal/agent", "/api/iq/knowledge", "/api/iq/knowledge/search", "/api/iq/second-brain", "/api/iq/hypotheses", "/api/iq/audit", "/api/iq/apprentice", "/api/iq/apprentice/trades", "/api/iq/stress/report", "/api/iq/account/context", "/api/iq/real/preflight"];
      const postPaths = ["/api/iq/consensus/execute", "/api/iq/connect", "/api/iq/verify-2fa", "/api/iq/disconnect", "/api/iq/arm", "/api/iq/disarm", "/api/iq/kill-switch", "/api/iq/test-order", "/api/iq/config/global-stake", "/api/iq/config/auto-execute", "/api/iq/mode", "/api/iq/real/confirm", "/api/iq/real/revoke", "/api/iq/real/arm", "/api/iq/real/disarm", "/api/iq/account/select", "/api/iq/stress/run", "/api/iq/stress/cancel", "/api/iq/knowledge/rebuild", "/api/iq/hypotheses", "/api/iq/hypotheses/evaluate", "/api/iq/journal/daily", "/api/iq/research/rsi-reversal/prepare", "/api/iq/research/rsi-reversal/arm", "/api/iq/research/rsi-reversal/stop", "/api/iq/research/rsi-variants/prepare", "/api/iq/research/rsi-variants/arm", "/api/iq/research/rsi-variants/stop", "/api/iq/v3/agents/selftest", "/api/iq/mesas/bulk"];
      const putPaths = ["/api/iq/mcp/config", "/api/iq/agents/config", "/api/iq/market", "/api/iq/supervisor/config", "/api/iq/entry/config", "/api/iq/apprentice/config", "/api/iq/mesas"];
      ...
      if (req.method === "GET") {
        ...
        const query = path === "/api/iq/executions"
          ...
          : path === "/api/iq/signals" ? `?limit=${Math.max(1, Math.min(200, Number(q.get("limit")) || 50))}${q.get("marketKey") ? `&marketKey=${encodeURIComponent(q.get("marketKey") as string)}` : ""}${contextQuery}`
          : path === "/api/iq/journal" ? `?limit=${Math.max(1, Math.min(200, Number(q.get("limit")) || 100))}${contextQuery}`
          ...
          : path === "/api/iq/v3/opportunities" ? `?${v3QueryParams(q)}`
          : path === "/api/iq/v3/status" || path === "/api/iq/v3/expirations" ? ""
      ...
      const payload: Record<string, unknown> | null = path === "/api/iq/connect" ? { email: String(operationalInput.email ?? "").trim(), password: String(operationalInput.password ?? "") }
        ...
        : path === "/api/iq/account/select" ? { context: operationalInput.context === "REAL" ? "REAL" : "PRACTICE" }
        : path === "/api/iq/real/arm" ? { phrase: String(operationalInput.phrase ?? "").slice(0, 40), acknowledgeRisk: operationalInput.acknowledgeRisk === true, maxStake: operationalInput.maxStake === undefined ? null : Number(operationalInput.maxStake), strategy: typeof operationalInput.strategy === "string" ? operationalInput.strategy.slice(0, 60) : null, actor: typeof operationalInput.actor === "string" ? operationalInput.actor.slice(0, 40) : "ui" }
        : path === "/api/iq/real/disarm" ? {}
        : path === "/api/iq/research/experiment/four-way/arm" ? { phrase: String(operationalInput.phrase ?? "").slice(0, 80), actor: typeof operationalInput.actor === "string" ? operationalInput.actor.slice(0, 40) : "ui" }
        : path === "/api/iq/research/rsi-reversal/arm" ? { phrase: String(operationalInput.phrase ?? "").slice(0, 80), actor: typeof operationalInput.actor === "string" ? operationalInput.actor.slice(0, 40) : "owner" }
        : path === "/api/iq/research/rsi-variants/arm" ? { phrase: String(operationalInput.phrase ?? "").slice(0, 80), actor: typeof operationalInput.actor === "string" ? operationalInput.actor.slice(0, 40) : "owner" }
        : path === "/api/iq/research/rsi-reversal/stop" ? { reason: String(operationalInput.reason ?? "MANUAL_STOP").slice(0, 80) }
        : path === "/api/iq/research/experiment/four-way/stop" ? { reason: String(operationalInput.reason ?? "MANUAL_STOP").slice(0, 80), actor: typeof operationalInput.actor === "string" ? operationalInput.actor.slice(0, 40) : "ui" }
        ...
        : path === "/api/iq/agents/config" ? { ...operationalInput }
        : path === "/api/iq/mcp/config" ? { token: String(operationalInput.token ?? "").slice(0, 400) }
        : {};
      ...
      const practiceOnly = contextPaths.includes(path) ? (path === "/api/iq/account/select" ? result.body.context !== "REAL" : false) : true;
      json(200, { state: result.body.state ?? (path === "/api/iq/disarm" ? "CONNECTED_PRACTICE" : "OK"), twoFactorRequired: result.body.twoFactorRequired === true, email: result.body.email ?? null, connectedAt: result.body.connectedAt ?? null, lastError: result.body.lastError ?? null, authErrorCode: result.body.authErrorCode ?? null, hasSession: result.body.hasSession === true, ...(path === "/api/iq/connect" || path === "/api/iq/verify-2fa" ? { ws: result.body.ws ?? null } : result.body), practiceOnly, brokerAutomation: path === "/api/iq/connect" || path === "/api/iq/verify-2fa" ? "NONE" : "WS_ONLY_PRACTICE" });
      return;
    }
